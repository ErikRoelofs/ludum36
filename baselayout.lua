...
progress = looky:build("numberAsBar", { width = "fill", height = 50, value = function() return getBadComputerCount() end, maxValue = 16, filledColor = { 255, 0, 0, 255 }, background = { 0, 0, 255, 255 }})
